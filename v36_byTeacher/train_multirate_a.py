...
def _strict_forward_half_3x6(full_centers, center_xy, heading_rad):
    ...
    del center_xy  # only the already-built predicted 6x6 window is needed here
    ...
    # Use the geometric center of the six-by-six lattice. For the normal grid
    # generated by regular_grid_indices this lies halfway between its two middle
    # rows/columns, giving a clean 18/18 rear/forward split.
    ...
    # Largest signed longitudinal coordinates are the strict forward half.
    # Dominant-axis selection keeps the support rectangular (3x6), unlike an
    # oblique top-18 projection which can form a diagonal/triangular half-plane.
    ...
    # Deterministic ordering only; it does not change which 18 are selected.
...
# Install the strict front-half selector before every train/eval rollout.
