...
# =============================================================================
# v36_byTeacher autonomous closed-loop architecture, stable v4
# =============================================================================
...
ARCHITECTURE_NAME = (
    "V36_byTeacher_Autonomous_MS1NearestForward3x6_KalmanPrevFinal_"
    "GRUPolynomial_MS2Center6x6_v4_nativeA"
)
...
OUTPUT_DIR = (
    ...
    / "autonomous_ms1_kf_gru_ms2_v4_nativeA"
)
CHECKPOINT_DIR = (
...
TEMPORAL_CHECKPOINT = (
    CHECKPOINT_DIR
    / f"autonomous_motion_gru_A_native_v4_{BACKBONE_KEY}.pt"
)
LATEST_TEMPORAL_CHECKPOINT = (
    CHECKPOINT_DIR
    / f"autonomous_motion_gru_A_native_v4_{BACKBONE_KEY}_latest.pt"
)
FEATURE_CACHE_DIR = (
