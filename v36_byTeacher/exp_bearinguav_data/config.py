...
# test-label-dependent correction.
MAX_FINAL_CROSS_TRACK_M = float(os.environ.get("BEARING_MAX_CROSS_TRACK_M", "25.0"))

# New protocol ID prevents stale city-B/city-C checkpoints and feature caches
# from being silently reused.
BEARING_DATA_PROTOCOL = "actualpose_samecity_2train1val_multiturn_v5"
