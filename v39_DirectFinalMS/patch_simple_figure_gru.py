...
sub1(r'^LOSS_VELOCITY\s*=\s*[0-9.]+\s*$', 'LOSS_VELOCITY = float(os.environ.get("UAVSAT_LOSS_VELOCITY", "0.40"))', 'velocity loss')
sub1(r'^LOSS_ACCELERATION\s*=\s*[0-9.]+\s*$', 'LOSS_ACCELERATION = float(os.environ.get("UAVSAT_LOSS_ACCELERATION", "0.25"))', 'acceleration loss')
