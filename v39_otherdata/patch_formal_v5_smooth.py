...
replacements = {
    ...
    'MAX_MEASUREMENT_CORRECTION_CROSS_M = 4.0': 'MAX_MEASUREMENT_CORRECTION_CROSS_M = float(os.environ.get("UAVSAT_MAX_MEASUREMENT_CORRECTION_CROSS_M", "2.5"))',
...
checks = {
    ...
    'cross_measurement_2p5m': 'UAVSAT_MAX_MEASUREMENT_CORRECTION_CROSS_M' in s,
