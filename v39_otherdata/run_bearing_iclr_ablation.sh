...
SUITE_ROOT="${ICLR_SUITE_ROOT:-${REPO_ROOT}/v39_otherdata/iclr_bearing_${CITY}_ablation_v5_${TS}}"
...
export UAVSAT_LOSS_VELOCITY="${UAVSAT_LOSS_VELOCITY:-0.0}"
export UAVSAT_LOSS_ACCELERATION="${UAVSAT_LOSS_ACCELERATION:-0.0}"
...
if [[ "${UPLOAD_RESULTS}" == "1" ]]; then
  ...
  dest="paper_results/iclr_bearing_${CITY}_ablation_v5_${TS}"
