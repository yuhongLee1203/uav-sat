...
class ThreeFrameRouteStateGRU(nn.Module):
    ...
    def __init__(self):
        ...
        # All motion heads start as zero residual around the city-cadence state.
    ...
    def forward_step(
        ...
        # Current-frame feature is the base. Temporal history enters as
        ...
        # Explicit second-order state exists only for the 3-frame model. V5
        ...
        # Frame-3-only direct acceleration correction. Acceleration itself is
