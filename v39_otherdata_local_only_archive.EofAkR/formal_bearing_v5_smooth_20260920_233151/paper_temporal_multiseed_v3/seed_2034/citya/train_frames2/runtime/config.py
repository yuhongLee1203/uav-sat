...
CHECKPOINT_DIR = Path(
    os.environ.get("UAVSAT_CHECKPOINT_DIR", str(OUTPUT_DIR / "checkpoints"))
).resolve()
...
# Deployment paths.  The packaged benchmark evaluates Route B+C only, so Route
# A is deliberately optional (it is needed only when training, not for NX eval).
DEPLOY_DATA_ROOT = Path(
    os.environ.get("UAVSAT_DATA_ROOT", str(PROJECT_ROOT.parent / "data"))
).resolve()
ROUTE_ROOTS = [
    Path(os.environ.get("UAVSAT_ROUTE_A", str(DEPLOY_DATA_ROOT / "routes" / "route_A"))),
    Path(os.environ.get("UAVSAT_ROUTE_B", str(DEPLOY_DATA_ROOT / "routes" / "route_B"))),
    Path(os.environ.get("UAVSAT_ROUTE_C", str(DEPLOY_DATA_ROOT / "routes" / "route_C"))),
]
...
SAT_IMAGE = Path(os.environ.get(
    "UAVSAT_SAT_IMAGE",
    str(DEPLOY_DATA_ROOT / "satellite" / "sim_map_competition_roi_crop.png"),
))
SAT_JSON = Path(os.environ.get(
    "UAVSAT_SAT_JSON",
    str(DEPLOY_DATA_ROOT / "satellite" / "sim_map_competition_roi_crop_worldfile_epsg3826.json"),
))
...
MAX_FORWARD_SPEED_M_PER_FRAME = float(os.environ.get("UAVSAT_MAX_FORWARD_SPEED_M_PER_FRAME", "12.0"))
MAX_CROSS_SPEED_M_PER_FRAME = float(os.environ.get("UAVSAT_MAX_CROSS_SPEED_M_PER_FRAME", "3.0"))
MAX_FINAL_CROSS_TRACK_M = 10.0
MAX_FORWARD_ACCEL_M_PER_FRAME2 = 5.0
MAX_CROSS_ACCEL_M_PER_FRAME2 = float(os.environ.get("UAVSAT_MAX_CROSS_ACCEL_M_PER_FRAME2", "2.0"))
MAX_POLYNOMIAL_STEP_M_PER_FRAME = float(os.environ.get("UAVSAT_MAX_POLYNOMIAL_STEP_M_PER_FRAME", "12.0"))
MAX_MEASUREMENT_CORRECTION_PARALLEL_M = float(os.environ.get("UAVSAT_CORR_PARALLEL_M", "0.75"))
MAX_MEASUREMENT_CORRECTION_CROSS_M = float(os.environ.get("UAVSAT_CORR_CROSS_M", "0.50"))
# -----------------------------------------------------------------------------
...
HEADING_STATE_EMA_ALPHA = float(os.environ.get("UAVSAT_HEADING_STATE_EMA_ALPHA", "0.22"))
TURN_RATE_EMA_ALPHA = float(os.environ.get("UAVSAT_TURN_RATE_EMA_ALPHA", "0.20"))
MAX_HEADING_DELTA_DEG_PER_FRAME = float(os.environ.get("UAVSAT_MAX_HEADING_DELTA_DEG_PER_FRAME", "3.0"))
MAX_TURN_RATE_DELTA_DEG_PER_FRAME2 = float(os.environ.get("UAVSAT_MAX_TURN_RATE_DELTA_DEG_PER_FRAME2", "3.0"))
...
LOSS_TURN_RATE = 0.0
EARLY_SCORE_HEADING_WEIGHT = float(os.environ.get("UAVSAT_EARLY_HEADING_WEIGHT", "0.002"))
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
TEMPORAL_EPOCHS = 60
TEMPORAL_LR = float(os.environ.get("UAVSAT_TEMPORAL_LR", "8e-5"))
...
EARLY_STOP_MIN_DELTA = float(os.environ.get("UAVSAT_EARLY_MIN_DELTA", "0.003"))
EARLY_STOP_MIN_EPOCH = int(os.environ.get("UAVSAT_EARLY_MIN_EPOCH", "10"))
# -----------------------------------------------------------------------------
...
LOSS_MEASUREMENT = float(os.environ.get("UAVSAT_LOSS_MEASUREMENT", "2.0"))
LOSS_NEXT_STEP = float(os.environ.get("UAVSAT_LOSS_NEXT_STEP", "2.5"))
...
LOSS_VELOCITY = float(os.environ.get("UAVSAT_LOSS_VELOCITY", "0.40"))
...
LOSS_ACCELERATION = float(os.environ.get("UAVSAT_LOSS_ACCELERATION", "0.25"))
...
LOSS_CROSS_MOTION_REG = float(os.environ.get("UAVSAT_LOSS_CROSS_MOTION_REG", "0.03"))
...
KALMAN_Q_PROGRESS = float(os.environ.get("UAVSAT_KALMAN_Q_PROGRESS", "1.50"))
KALMAN_Q_CROSS = float(os.environ.get("UAVSAT_KALMAN_Q_CROSS", "0.40"))
KALMAN_Q_VELOCITY = float(os.environ.get("UAVSAT_KALMAN_Q_VELOCITY", "1.00"))
...
MOTION_VELOCITY_EMA_ALPHA = float(os.environ.get("UAVSAT_MOTION_VEL_ALPHA", "0.65"))
MOTION_ACCELERATION_EMA_ALPHA = 0.35
MAX_MOTION_VELOCITY_DELTA_M_PER_FRAME = 2.0
MAX_MOTION_ACCEL_DELTA_M_PER_FRAME2 = 1.5
MOTION_POLYNOMIAL_STEP_EMA_ALPHA = float(os.environ.get("UAVSAT_MOTION_STEP_ALPHA", "0.70"))
...
KALMAN_MAX_POSTERIOR_CORRECTION_CROSS_M = float(os.environ.get("UAVSAT_KALMAN_MAX_POSTERIOR_CORRECTION_CROSS_M", "1.25"))
KALMAN_MAX_VELOCITY_CORRECTION_M_PER_FRAME = float(os.environ.get("UAVSAT_KALMAN_MAX_VELOCITY_CORRECTION_M_PER_FRAME", "0.90"))
KALMAN_FINAL_STEP_SLACK_M = 0.00
KALMAN_FINAL_STEP_MIN_M = 0.00
KALMAN_FINAL_STEP_MAX_M = float(os.environ.get("UAVSAT_KALMAN_FINAL_STEP_MAX_M", "6.0"))
...
ROUTE_FRAME_SMOOTH_RADIUS_M = float(os.environ.get("UAVSAT_ROUTE_FRAME_SMOOTH_RADIUS_M", "36.0"))
...
EARLY_SCORE_SPEED_WEIGHT = float(os.environ.get("UAVSAT_EARLY_SPEED_WEIGHT", "0.05"))
EARLY_SCORE_PROGRESS_WEIGHT = float(os.environ.get("UAVSAT_EARLY_PROGRESS_WEIGHT", "0.03"))
EARLY_SCORE_MISS_WEIGHT = float(os.environ.get("UAVSAT_EARLY_MISS_WEIGHT", "0.02"))
...
SEED = int(os.environ.get("UAVSAT_SEED", "2033"))
DEVICE = os.environ.get("UAVSAT_DEVICE", "cuda")
