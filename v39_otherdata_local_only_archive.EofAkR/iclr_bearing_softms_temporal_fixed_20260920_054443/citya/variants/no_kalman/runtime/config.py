...
RNN_DROPOUT = float(os.environ.get("UAVSAT_RNN_DROPOUT", "0.10"))
...
LOSS_TURN_RATE = 0.0
EARLY_SCORE_HEADING_WEIGHT = float(os.environ.get("UAVSAT_EARLY_HEADING_WEIGHT", "0.01"))
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
TEMPORAL_EPOCHS = 60
TEMPORAL_LR = float(os.environ.get("UAVSAT_TEMPORAL_LR", "2e-4"))
...
EARLY_STOP_MIN_DELTA = float(os.environ.get("UAVSAT_EARLY_MIN_DELTA", "0.01"))
...
LOSS_MEASUREMENT = float(os.environ.get("UAVSAT_LOSS_MEASUREMENT", "2.50"))
LOSS_NEXT_STEP = float(os.environ.get("UAVSAT_LOSS_NEXT_STEP", "1.50"))
...
LOSS_VELOCITY = float(os.environ.get("UAVSAT_LOSS_VELOCITY", "0.10"))
...
MOTION_VELOCITY_EMA_ALPHA = float(os.environ.get("UAVSAT_MOTION_VEL_ALPHA", "0.35"))
MOTION_ACCELERATION_EMA_ALPHA = 0.35
MAX_MOTION_VELOCITY_DELTA_M_PER_FRAME = 2.0
MAX_MOTION_ACCEL_DELTA_M_PER_FRAME2 = 1.5
MOTION_POLYNOMIAL_STEP_EMA_ALPHA = float(os.environ.get("UAVSAT_MOTION_STEP_ALPHA", "0.40"))
...
EARLY_SCORE_SPEED_WEIGHT = float(os.environ.get("UAVSAT_EARLY_SPEED_WEIGHT", "0.20"))
