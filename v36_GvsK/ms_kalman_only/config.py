...
ARCHITECTURE_NAME = os.environ.get(
    ...
    "V36_SoftMS_KalmanOnly_Forward3x6",
)
...
EXPERIMENT_MOTION = os.environ.get("UAVSAT_EXPERIMENT_MOTION", "none")
EXPERIMENT_KALMAN = os.environ.get("UAVSAT_EXPERIMENT_KALMAN", "learned")
EXPERIMENT_DISABLE_GRU = os.environ.get("UAVSAT_EXPERIMENT_DISABLE_GRU", "1") == "1"
