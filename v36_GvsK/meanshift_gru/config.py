...
ARCHITECTURE_NAME = os.environ.get(
    ...
    "V36GvsK_SoftMS_GRUVisualFinal_Forward3x6",
)
...
# GvsK variant: Soft Mean-Shift supplies the local visual anchor and the GRU
# predicts its residual correction.  That GRU-corrected visual measurement is
# the final localization output; RouteKalman.update(..., mode="none") only
# retains the previous route-coordinate state for the next causal search.
EXPERIMENT_KALMAN = os.environ.get("UAVSAT_EXPERIMENT_KALMAN", "none")
